    ...
    <section class="session-side-open">
      ...
      <Switch>
        ...
        <Match when={activeTab()?.kind === "web"}>
          <SessionSideBrowserHost preview={browser.activePreview()} parked={browser.parkedID() === activeTab()?.id} available={Boolean(window.opencodex?.browser)} setHost={browser.setHost} />
        </Match>
