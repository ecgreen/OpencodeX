...
export const Definitions = {
  ...
  opencodex_dashboard_open: keybind("ctrl+l", "Open OpenCodeX dashboard"),
  ...
  opencodex_project_folders: keybind("ctrl+e", "Edit OpencodeX project folders"),
  ...
  opencodex_view_create: keybind("<leader>v", "Create an OpencodeX view"),
  opencodex_sidebar_toggle: keybind("ctrl+s", "Toggle sidebar"),
  opencodex_sidebar_focus: keybind("<leader>f", "Focus sidebar"),
  opencodex_swarm_create: keybind("super+shift+n", "Create OpenCodeX swarm"),
  opencodex_swarm_list: keybind("super+shift+d,<leader>w", "View OpenCodeX swarms"),
  opencodex_swarm_open: keybind("super+shift+o", "Open OpenCodeX swarm"),
  opencodex_swarm_task: keybind("super+shift+t", "Create OpenCodeX swarm task"),
  opencodex_swarm_route_up: keybind("ctrl+alt+up", "Select previous swarm"),
  opencodex_swarm_route_down: keybind("ctrl+alt+down", "Select next swarm"),
  opencodex_swarm_route_open: keybind("ctrl+alt+o", "Open selected swarm"),
  opencodex_swarm_route_create: keybind("ctrl+alt+n", "Create swarm"),
  opencodex_swarm_route_start: keybind("ctrl+alt+s", "Start selected swarm"),
  opencodex_swarm_route_cancel: keybind("ctrl+alt+x", "Cancel selected swarm"),
  opencodex_swarm_route_dashboard: keybind("ctrl+alt+d", "Open dashboard"),
  opencodex_swarm_route_refresh: keybind("ctrl+alt+r", "Refresh swarms"),
  ...
  "dialog.folder_picker.prev": keybind("up,ctrl+p", "Move to previous folder"),
  "dialog.folder_picker.next": keybind("down,ctrl+n", "Move to next folder"),
  "dialog.folder_picker.page_up": keybind("pageup", "Move up one page in folder picker"),
  "dialog.folder_picker.page_down": keybind("pagedown", "Move down one page in folder picker"),
  "dialog.folder_picker.home": keybind("home", "Move to first folder"),
  "dialog.folder_picker.end": keybind("end", "Move to last folder"),
  "dialog.folder_picker.open": keybind("right", "Open folder or typed path"),
  "dialog.folder_picker.parent": keybind("left", "Go to parent folder"),
  "dialog.folder_picker.toggle": keybind("return", "Toggle folder selection"),
  "dialog.folder_picker.confirm": keybind("ctrl+return", "Confirm selected folders"),
...
export const KeybindNames = new Set<string>(Object.keys(Definitions))
...
export const CommandMap = {
  ...
  opencodex_dashboard_open: "opencodex.dashboard.open",
  opencodex_project_create: "opencodex.project.create",
  opencodex_project_manage: "opencodex.project.manage",
  opencodex_project_folders: "opencodex.project.folders",
  ...
  opencodex_view_create: "opencodex.view.create",
  opencodex_sidebar_toggle: "opencodex.sidebar.toggle",
  opencodex_sidebar_focus: "opencodex.sidebar.focus",
  opencodex_swarm_create: "opencodex.swarm.create",
  opencodex_swarm_list: "opencodex.swarm.list",
  opencodex_swarm_open: "opencodex.swarm.open",
  opencodex_swarm_task: "opencodex.swarm.task",
  opencodex_swarm_route_up: "opencodex.swarm.route.up",
  opencodex_swarm_route_down: "opencodex.swarm.route.down",
  opencodex_swarm_route_open: "opencodex.swarm.route.open",
  opencodex_swarm_route_create: "opencodex.swarm.route.create",
  opencodex_swarm_route_start: "opencodex.swarm.route.start",
  opencodex_swarm_route_cancel: "opencodex.swarm.route.cancel",
  opencodex_swarm_route_dashboard: "opencodex.swarm.route.dashboard",
  opencodex_swarm_route_refresh: "opencodex.swarm.route.refresh",
