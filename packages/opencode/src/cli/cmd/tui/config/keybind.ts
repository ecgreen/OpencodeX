...
export const Definitions = {
  ...
  opencodex_dashboard: keybind("ctrl+u", "Go to OpencodeX dashboard"),
  opencodex_project_create: keybind("<leader>p", "Create OpencodeX project"),
  opencodex_project_delete: keybind("none", "Delete OpencodeX project"),
...
export const CommandMap = {
  ...
  opencodex_dashboard: "opencodex.dashboard",
  opencodex_project_create: "opencodex.project.create",
  opencodex_project_delete: "opencodex.project.delete",
