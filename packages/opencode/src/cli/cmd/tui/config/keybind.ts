...
export const Definitions = {
  ...
  opencodex_project_create: keybind("<leader>p", "Create OpencodeX project"),
  opencodex_project_manage: keybind("ctrl+u", "Manage OpencodeX projects"),
  opencodex_project_move_up: keybind("k", "Move OpencodeX project up"),
  opencodex_project_move_down: keybind("j", "Move OpencodeX project down"),
  opencodex_session_manage: keybind("ctrl+o", "Manage OpencodeX sessions"),
  opencodex_session_new_project: keybind("ctrl+n", "Create a new session in an OpencodeX project"),
  opencodex_sidebar_toggle: keybind("ctrl+s", "Toggle sidebar"),
...
export const CommandMap = {
  ...
  opencodex_project_create: "opencodex.project.create",
  opencodex_project_manage: "opencodex.project.manage",
  opencodex_project_move_up: "opencodex.project.move_up",
  opencodex_project_move_down: "opencodex.project.move_down",
  opencodex_session_manage: "opencodex.session.manage",
  opencodex_session_new_project: "opencodex.session.new_project",
  opencodex_sidebar_toggle: "opencodex.sidebar.toggle",
